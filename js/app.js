...
// Select a level -- each level button is linked to its respective level html file
...
// User has the option to play the level over (if they didn't win or want to get a higher score), -- link to current
// return back to the menu, or if they cleared the level, they can advance to the next level -- link to next
